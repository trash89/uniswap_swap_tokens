...
contract TestUniswap is IUniswapV2Callee {
  ...
  */
    ...
    function uniswapV2Call(
        ...
        // do stuff here
        emit Log("uniswapV2Call(): amount borrowed by flashswap:", amount);
        emit Log("uniswapV2Call(): amount0", _amount0);
        emit Log("uniswapV2Call(): amount1", _amount1);
        emit Log("uniswapV2Call(): fee", fee);
        emit Log("uniswapV2Call(): amount to repay", amountToRepay);
